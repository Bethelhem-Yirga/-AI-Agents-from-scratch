"""
LangGraph Agent with OpenRouter (Free alternative to OpenAI)
"""
...
from typing import Annotated, Callable, Dict, Iterable, List, Optional, Sequence, TypedDict
...
class OpenRouterLLM:
    ...
    def __init__(self, model: str = "google/gemma-4-26b-a4b-it:free", temperature: float = 0.2):
        ...
        # ✅ Use the already loaded environment
...
class LangGraphChatAgent:
    ...
    llm: OpenRouterLLM = field(init=False)
    history: List[BaseMessage] = field(init=False)

    def __post_init__(self) -> None:
        self.llm = OpenRouterLLM(model=self.model, temperature=self.temperature)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="OpenRouter model (default: google/gemma-4-26b-a4b-it:free).",
    )
    parser.add_argument(
        "--temperature",
        type=float,
...
def main() -> None:
    ...
    if not os.getenv("OPENROUTER_API_KEY"):
        ...
        print("Please add your key to: " + str(project_root / '.env'))
