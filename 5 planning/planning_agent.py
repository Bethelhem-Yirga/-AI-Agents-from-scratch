...
With real APIs and multiple tools!
"""
...
SYSTEM_PROMPT = (
    ...
    "needed, and provide a concise final answer. You have access to real "
    "APIs for weather, currency conversion, search, calendar, and maps. "
    "Use these tools to gather accurate information."
)
...
def main() -> None:
    ...
    planner = ReActPlanner(tools=tools, max_steps=8)
